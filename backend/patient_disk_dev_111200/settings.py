"""
Django settings for patient_disk_dev_111200 project.
...
ROOT_URLCONF = 'patient_disk_dev_111200.urls'
...
WSGI_APPLICATION = 'patient_disk_dev_111200.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_disk_dev_111200 API",
    "DESCRIPTION": "API documentation for patient_disk_dev_111200 App",
    "VERSION": "v1",
}
