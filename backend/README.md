...
## Project Structure
    ...
    ├── patient_disk_dev_111200  # Django project configurations
...
1. Clone this repo and `cd patient_disk_dev_111200`
...
2. Clone this repo and `cd patient_disk_dev_111200`
